...
class Usuarioadmin(admin.ModelAdmin):
    list_display = ('idtipousuario','username','password')
...
class PreferenciaPersonaladmin(admin.ModelAdmin):
    list_display = ('idcategoriapreferenciapersonal','nombrepreferenciapersonal','descripcion')
...
class UsuarioProductoEmpresaTitularadmin(admin.ModelAdmin):
    list_display = ('id','usuario','idproductoempresatitular')
